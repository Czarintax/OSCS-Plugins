...
new const DICTIONARY_FILENAME[] = "HealthNade.txt";
...
new const VIEWMODEL[] = "models/reapi_healthnade/v_healthnade.mdl";
...
explodeNade(const grenade) {
	...
	emit_sound(grenade, CHAN_WEAPON, SOUND_EXPLODE, VOL_NORM, ATTN_NORM, 0, PITCH_NORM);
