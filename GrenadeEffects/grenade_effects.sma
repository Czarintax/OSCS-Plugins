...
new bool:g_OptionSwitch[MAX_PLAYERS + 1];
...
public CmdOptionSwitch(id) {
    ...
    pp_set_bool(id, "grenade_effects", g_OptionSwitch[id]);
    client_print(id, print_chat, "%l", "GE_DYNLIGHT_MESSAGE", fmt("%l", g_OptionSwitch[id] ? "GE_DYNLIGHT_EFFECT_ON" : "GE_DYNLIGHT_EFFECT_OFF"));
}
